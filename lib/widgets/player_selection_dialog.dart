...
class _PlayerSelectionDialogWidgetState
  ...
  List<Map<String, dynamic>> _filteredUsers = []; // 검색 필터링된 유저 목록
  ...
  double _getDynamicSelectionButtonSize(double containerWidth) {
    return (containerWidth * 0.105).clamp(21.0, 35.0); // 컨테이너 폭의 10.5% (15%에서 30% 감소)
  }

  double _getDynamicSelectionIconSize(double containerWidth) {
    return (containerWidth * 0.07).clamp(14.0, 24.5); // 컨테이너 폭의 7% (10%에서 30% 감소)
  }
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      ...
      setState(() {
        _users = users;
        _filteredUsers = users; // 초기에는 모든 유저를 보여줌
        _isLoading = false;
      });
    } catch (e) {
      setState(() {
    ...
    setState(() {
      if (searchTerm.isEmpty) {
        ...
        _filteredUsers = _users.where((user) {
          ...
          return nickname.contains(searchTerm) || country.contains(searchTerm);
        }).toList();
      }
    });
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSearchBar(),
              SizedBox(height: _verticalSpacing * 0.8),
              _buildActionChips(),
              SizedBox(height: _verticalSpacing * 1.2),
  ...
  Widget _buildActionChips() {
    return Row(
      children: [
          ...
          GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(
                ...
                vertical: _verticalSpacing * 0.4,
              ),
              decoration: BoxDecoration(
                color: Colors.orange.shade100,
                borderRadius: BorderRadius.circular(_dialogBorderRadius * 0.5),
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: _horizontalSpacing * 0.3),
                  FittedBox(
                    fit: BoxFit.scaleDown,
                    child: Text(
                      _translations['solo_play'] ?? 'Solo Play',
                      style: _getTextStyle(
        ...
        Container(
          padding: EdgeInsets.symmetric(
            horizontal: _horizontalSpacing * 0.6,
          ...
          child: FittedBox(
            fit: BoxFit.scaleDown,
            child: Text(
              '${_selectedUsers.length}/3 ${_translations['players'] ?? 'players'}',
              style: _getTextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              FittedBox(
                ...
                child: Text(
                  _searchController.text.isNotEmpty
                      ? _translations['no_search_results'] ?? 'No players found'
              ...
              if (_searchController.text.isNotEmpty) ...[
                SizedBox(height: _verticalSpacing * 0.3),
                FittedBox(
                  fit: BoxFit.scaleDown,
                  child: Text(
                    _translations['try_different_search'] ?? 'Try a different search term',
                    style: _getTextStyle(
                      fontSize: _bodyFontSize,
