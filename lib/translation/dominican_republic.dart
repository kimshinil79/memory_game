...
// Spanish translations for Dominican Republic
const Map<String, String> esDOTranslations = {
  ...
  'failed_to_load_users': 'Error al cargar la lista de usuarios',
  'country': 'País',
  'level': 'Nivel',
  'unknown': 'Desconocido',
  ...
  'enter_pin_for': 'Ingresa el PIN para',
  ...
  'multi_game_pin': 'PIN del juego multijugador',
  ...
  'points_divided_explanation': '(Puntos divididos en caso de empate)',
  ...
  'card_selection_desc': 'Toca las cartas para encontrar pares.',
  'time_limit_title': 'Límite de tiempo',
  'time_limit_desc':
      'Encuentra todos los pares antes de que se acabe el tiempo. Encuentra pares rápidamente para más puntos.',
  'add_time_title': 'Agregar tiempo',
  'add_time_desc':
      'Toca "+30s" para agregar tiempo (cuesta puntos de salud cerebral).',
  ...
  'age': 'Edad',
  'update': 'Actualizar',
  'points_to_next_level': 'Necesitas {points} puntos para el siguiente nivel',
  ...
  'cognitive_function_enhancement': 'Mejora de las funciones cognitivas',
  'cognitive_function_desc':
      'La actividad cerebral regular ayuda a proteger y mejorar las funciones cognitivas.',
  'response_time_reduction': 'Reducción del tiempo de reacción',
  'response_time_desc':
      'Encontrar pares rápidamente mejora el tiempo de reacción y la velocidad de procesamiento.',
  'dementia_prevention': 'Prevención de la demencia',
  'dementia_prevention_desc':
      'El ejercicio cerebral regular ayuda a reducir el riesgo de demencia y deterioro cognitivo.',
  ...
  'audio_assistance_desc':
      'Toca el icono de audio para escuchar la palabra correcta. El sonido se reproduce en el idioma seleccionado.',
  ...
  'select_and_submit_desc':
      'Selecciona una imagen para cada pregunta. El botón de envío aparece después de responder todas las preguntas.',
