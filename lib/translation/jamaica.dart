...
// Jamaica translations (English)
const Map<String, String> jmTranslations = {
  ...
  'points_divided_explanation': '(Points divided among players)',
  ...
  'card_selection_desc': 'Tap on cards to flip them and find matching pairs.',
  'time_limit_title': 'Time Limit',
  'time_limit_desc': 'Complete the game before time runs out.',
  'add_time_title': 'Add Time',
  'add_time_desc': 'Find matching pairs to add more time.',
  'multiplayer_title': 'Multiplayer',
  'multiplayer_desc': 'Play with friends and compete for the highest score.',
  ...
  'brain_health_index_desc': 'Track your cognitive performance over time.',
  ...
  'game_statistics_desc': 'View detailed statistics of your gameplay.',
  'got_it': 'Got it!',
  ...
  'short_term_memory_desc':
      'Enhance your ability to remember information for short periods.',
  ...
  'response_time_desc': 'Train your brain to react faster to visual stimuli.',
  'dementia_prevention': 'Dementia Prevention',
  'dementia_prevention_desc':
      'Regular brain training may help prevent cognitive decline.',
  ...
  'question_navigation_desc': 'Navigate through test questions easily.',
  ...
  'results_and_progress_desc': 'View your test results and track progress.',
