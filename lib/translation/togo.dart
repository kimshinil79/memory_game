...
// Togo translations (French)
const Map<String, String> frTGTranslations = {
  ...
  'enter_pin_for': 'Entrer le code PIN pour {name}',
  'no_pin_for': 'Pas de code PIN pour {name}',
  ...
  'nickname': 'Pseudonyme',
  'enter_nickname': 'Entrer votre pseudonyme',
  ...
  'multi_game_pin': 'Code PIN multijoueur',
  ...
  'password_length_error': 'Le mot de passe doit être à 2 chiffres',
  ...
  'card_selection_desc': 'Retourner les cartes pour trouver les paires',
  'time_limit_title': 'Limite de temps',
  'time_limit_desc': 'Terminer le jeu avant la fin du temps',
  'add_time_title': 'Ajouter du temps',
  'add_time_desc': 'Trouver des paires pour ajouter du temps',
  'multiplayer_title': 'Multijoueur',
  'multiplayer_desc': 'Jouer avec des amis et obtenir des points bonus',
  ...
  'brain_health_index_desc': 'Suivre votre santé cérébrale',
  'activity_graph_title': 'Graphique d\'activité',
  'activity_graph_desc': 'Voir votre activité cérébrale quotidienne',
  'ranking_system_title': 'Système de classement',
  'ranking_system_desc': 'Comparer vos points avec d\'autres joueurs',
  'game_statistics_title': 'Statistiques du jeu',
  'game_statistics_desc': 'Voir vos statistiques de jeu',
  'got_it': 'Compris!',

  // Brain Health Dashboard additional texts
  'play_memory_games_description':
      'Jouer à des jeux de mémoire pour améliorer votre santé cérébrale',
  ...
  // Login Prompt texts
  'start_tracking_brain_health': 'Commencer à suivre votre santé cérébrale',
  ...
  'start_playing_memory_games': 'Commencer à jouer aux jeux de mémoire',
  ...
  'cognitive_function_desc':
      'Améliorez votre cerveau et votre mémoire à court terme',
  'response_time_reduction': 'Réduction du temps de réponse',
  'response_time_desc': 'Apprenez à répondre plus rapidement',
  'dementia_prevention': 'Prévention de la démence',
  'dementia_prevention_desc':
      'Les jeux de mémoire aident à prévenir la démence',

  // Test Page texts
  'memory_test': 'Test de mémoire',
  'question': 'Question',
  'visual_memory_test': 'Test de mémoire visuelle',
  'visual_memory_test_desc': 'Testez votre mémoire',
  'audio_assistance': 'Assistance audio',
  'audio_assistance_desc': 'Utilisez l\'audio pour une meilleure compréhension',
  'question_navigation': 'Navigation des questions',
  'question_navigation_desc': 'Naviguez facilement entre les questions',
  ...
  'results_and_progress_desc': 'Voir vos résultats et progrès',
...
'by_country': 'Par Pays',
  ...
  'login_prompt_1': '🎯 Enregistrez vos scores et compétez dans les classements mondiaux!',
