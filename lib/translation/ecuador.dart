...
// Spanish translations for Ecuador
const Map<String, String> esECTranslations = {
  ...
  'multi_game_pin': 'PIN de juego multijugador',
  ...
  'card_selection_desc': 'Toca las cartas para encontrar parejas.',
  'time_limit_title': 'Límite de tiempo',
  'time_limit_desc':
      'Encuentra todas las parejas antes de que se acabe el tiempo. Encuentra parejas rápidamente para obtener más puntos.',
  ...
  'activity_graph_desc':
      'Observa cómo cambia tu índice de salud cerebral en el tiempo en el gráfico.',
  ...
  'game_statistics_desc':
      'Consulta diversas estadísticas como juegos jugados, parejas encontradas y mejores tiempos.',
  'got_it': '¡Entendido!',
  ...
  'response_time_desc':
      'Encontrar parejas rápidamente mejora el tiempo de respuesta y la velocidad de procesamiento.',
