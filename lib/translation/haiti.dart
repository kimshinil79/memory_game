...
// Haiti translations (French)
const Map<String, String> htTranslations = {
  ...
  'two_digit_pin_helper': 'Le PIN doit être à 2 chiffres',
  ...
  'card_selection_desc':
      'Appuyez sur les cartes pour les retourner et trouver les paires correspondantes.',
  'time_limit_title': 'Limite de temps',
  'time_limit_desc': 'Terminez le jeu avant que le temps ne soit écoulé.',
  'add_time_title': 'Ajouter du temps',
  'add_time_desc':
      'Trouvez des paires correspondantes pour ajouter plus de temps.',
  'multiplayer_title': 'Multijoueur',
  'multiplayer_desc':
      'Jouez avec des amis et rivalisez pour le meilleur score.',
  ...
  'brain_health_index_desc':
      'Suivez vos performances cognitives dans le temps.',
  'activity_graph_title': 'Graphique d\'activité',
  'activity_graph_desc':
      'Consultez votre activité quotidienne d\'entraînement cérébral.',
  ...
  'game_statistics_desc':
      'Consultez les statistiques détaillées de votre gameplay.',
  'got_it': 'Compris !',
  ...
  'short_term_memory_desc':
      'Améliorez votre capacité à mémoriser des informations sur de courtes périodes.',
  'cognitive_function_enhancement': 'Amélioration des fonctions cognitives',
  'cognitive_function_desc':
      'Améliorez votre fonction cérébrale globale et votre vitesse de traitement.',
  'response_time_reduction': 'Réduction du temps de réponse',
  'response_time_desc':
      'Entraînez votre cerveau à réagir plus rapidement aux stimuli visuels.',
  'dementia_prevention': 'Prévention de la démence',
  'dementia_prevention_desc':
      'L\'entraînement cérébral régulier peut aider à prévenir le déclin cognitif.',
  ...
  'visual_memory_test_desc':
      'Testez votre capacité à mémoriser des motifs visuels.',
  'audio_assistance': 'Assistance audio',
  'audio_assistance_desc':
      'Activez les indices audio pour une meilleure accessibilité.',
  'question_navigation': 'Navigation des questions',
  'question_navigation_desc':
      'Naviguez facilement à travers les questions du test.',
  'select_and_submit': 'Sélectionner et soumettre',
  'select_and_submit_desc': 'Choisissez votre réponse et soumettez le test.',
  'results_and_progress': 'Résultats et progrès',
  'results_and_progress_desc':
      'Consultez vos résultats de test et suivez vos progrès.',
