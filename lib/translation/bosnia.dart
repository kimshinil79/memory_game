...
const Map<String, String> bsBATranslations = {
  ...
  'incorrect_current_password': 'Pogrešna trenutna lozinka',
  'error_changing_password': 'Greška pri promjeni lozinke',
  'error': 'Greška',
  'sign_out': 'Odjavi se',
  'delete_account': 'Izbriši račun',
  'random_shake': 'Promiješaj karte!',
  ...
  'ranking_system_desc':
      'Usporedi svoj indeks zdravlja mozga s drugim korisnicima i provjeri svoju poziciju.',
  ...
  'age': 'Dob',
  'update': 'Ažuriraj',
  'points_to_next_level': 'Potrebno {points} bodova za sljedeći nivo',
  'maximum_level_reached': 'Dostignut maksimalni nivo',
  'index_components': 'Komponente indeksa',
  'age_factor': 'Faktor dobi',
  'recent_activity': 'Nedavna aktivnost',
  'game_performance': 'Učinak igre',
  'persistence_bonus': 'Bonus za upornost',
  'inactivity_penalty': 'Kazna za neaktivnost',
  'inactivity_warning':
      'Nisi igrao {days} dana. Tvoj indeks se svakodnevno smanjuje!',
  ...
  'login_prompt_desc':
      'Prijavi se da pratiš svoj indeks zdravlja mozga i vidiš svoj napredak. Poboljšaj svoje kognitivne sposobnosti kroz igre pamćenja.',
  'sign_in': 'Prijavi se',
  'login': 'Login',
  ...
  'promo_message_2': 'Savršeno za koncentraciju vašeg djeteta! ✨ Izgradite vještine fokusiranja i zapažanja u kratkim sesijama.',
  'promo_message_3': 'Povećajte efikasnost učenja uz pop-up igre! 🚀 Trenirajte svoju memoriju, temelj učenja.',
  ...
  'promo_message_7': 'Umoran mozak od prekovremenog rada? 💡 Pojačajte fokus na poslu sa samo 5 minuta dnevno.',
