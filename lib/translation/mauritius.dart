...
// Mauritius translations (English)
const Map<String, String> muMUTranslations = {
  ...
  'card_selection_desc': 'Click on cards to flip them and find matching pairs',
  'time_limit_title': 'Time Limit',
  'time_limit_desc': 'You have limited time to complete the game',
  'add_time_title': 'Add Time',
  'add_time_desc': 'You can add more time when finding a matching pair',
  'multiplayer_title': 'Multiplayer',
  'multiplayer_desc': 'You can play with your friends on the same device',
  ...
  'brain_health_index_desc': 'Track your progress in improving brain health',
  'activity_graph_title': 'Activity Graph',
  'activity_graph_desc': 'View your activity over time',
  'ranking_system_title': 'Ranking System',
  'ranking_system_desc': 'Compare your performance with others',
  'game_statistics_title': 'Game Statistics',
  'game_statistics_desc': 'View your detailed statistics',
  'got_it': 'Got it',
  ...
  'inactivity_warning': "Haven't played for {days} days",
  ...
  'login_prompt_desc':
      'Sign in to track your progress in improving brain health',
  'sign_in': 'Sign In',
  'login': 'Login',
  ...
  'welcome_to_brain_health': 'Welcome to Brain Health Dashboard',
  'start_playing_memory_games':
      'Start playing memory games to improve your brain health',
  ...
  'short_term_memory_desc':
      'Memory games enhance your ability to remember information in the short term',
  'cognitive_function_enhancement': 'Cognitive Function Enhancement',
  'cognitive_function_desc':
      'Helps improve thinking and problem-solving skills',
  'response_time_reduction': 'Response Time Reduction',
  'response_time_desc':
      'Improves information processing speed and decision-making',
  'dementia_prevention': 'Dementia Prevention',
  'dementia_prevention_desc':
      'Helps maintain brain health and reduce the risk of dementia',
  ...
  'visual_memory_test_desc':
      'Test your ability to remember images and patterns',
  'audio_assistance': 'Audio Assistance',
  'audio_assistance_desc': 'Listen to audio instructions',
  ...
  'select_and_submit_desc': 'Choose your answer and press submit',
