...
const Map<String, String> amTranslations = {
  ...
  'login_prompt_1': '🎯 ውጤቶችዎን ያስቀምጡ እና በአለም አቀፍ ደረጃዎች ላይ ይወዳደሩ!',
  'login_prompt_2': '🧠 የአእምሮ ጤና ውጤትዎን ይከታተሉ እና እድገትዎን ይመልከቱ!',
  'login_prompt_3': '🏆 ጓደኞችዎን በብዙ ተጫዋች ጨዋታዎች ይፈታተኑ!',
  'login_prompt_4': '📊 የጨዋታ ስታቲስቲክስዎን ያረጋግጡ እና ክህሎቶችዎን ያሻሽሉ!',
  'login_prompt_5': '⭐ ተጨማሪ አስደናቂ ባህሪያትን ለመክፈት ይመዝገቡ!',
  'login_prompt_6': '🎮 ከጓደኞችዎ ጋር የአእምሮ ጤናን ያሳድጉ!',
  'login_prompt_7': '📈 የግል ሪከርዶችን ያስቀምጡ እና ችሎታዎን ያሳድጉ!',
