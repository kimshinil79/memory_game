...
const Map<String, String> esESTranslations = {
  ...
  'promo_message_1': '¡Comienza el desarrollo cerebral de tu hijo a través del juego! 🎨 ¡Juegos divertidos que potencian las habilidades de memoria!',
  ...
  'promo_message_3': '¡Aumenta la eficiencia del aprendizaje con juegos emergentes! 🚀 Entrena tu memoria, la base del estudio.',
  'promo_message_4': '¿Puedes terminar más rápido que tus amigos? 👀 ¡Experimenta logros y activación cerebral a través de desafíos!',
  ...
  'promo_message_7': '¿Cerebro cansado por horas extras? 💡 Aumenta el enfoque laboral con solo 5 minutos al día.',
