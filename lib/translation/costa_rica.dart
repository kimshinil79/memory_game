...
// Costa Rica Spanish translations
const Map<String, String> esCRTranslations = {
  ...
  'flips': 'Volteos: {count}',
  'players_score_multiplier': '({players} jugadores: puntaje ×{multiplier})',
  ...
  'card_selection_desc': 'Toca las cartas para encontrar pares coincidentes.',
  'time_limit_title': 'Límite de tiempo',
  'time_limit_desc':
      'Encuentra todos los pares antes de que se acabe el tiempo. Encuentra coincidencias rápidamente para obtener más puntos.',
  ...
  'activity_graph_desc':
      'Ve cómo cambia tu índice de salud cerebral con el tiempo en el gráfico.',
  ...
  'game_statistics_desc':
      'Ve varias estadísticas como juegos jugados, pares encontrados y mejores tiempos.',
  'got_it': '¡Entendido!',
  ...
  'age': 'Edad',
  'update': 'Actualizar',
  'points_to_next_level': 'Necesitas {points} puntos para subir de nivel',
  'maximum_level_reached': 'Has alcanzado el nivel máximo',
  ...
  'inactivity_warning':
      'No has jugado en {days} días. ¡Tu índice está disminuyendo cada día!',
  ...
  'cognitive_function_desc':
      'La actividad cerebral regular ayuda a proteger y mejorar la función cognitiva.',
  'response_time_reduction': 'Reducción del tiempo de respuesta',
  'response_time_desc':
      'Las coincidencias rápidas mejoran el tiempo de respuesta y la velocidad de procesamiento.',
  ...
  'visual_memory_test_desc':
      'Pon a prueba tu memoria con 10 preguntas. Selecciona la imagen que coincida con la palabra correcta.',
  ...
  'select_and_submit_desc':
      'Selecciona una imagen para cada pregunta. El botón de enviar aparecerá después de responder todas las preguntas.',
