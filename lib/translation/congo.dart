...
// Congo French translations
const Map<String, String> frCGTranslations = {
  ...
  'pin_is_2_digits': 'Le code PIN doit avoir 2 chiffres',
  ...
  'enter_two_digit_pin': 'Entrez un code PIN à 2 chiffres',
  'two_digit_pin_helper':
      'Ce code PIN est utilisé pour les sessions multijoueur',
  ...
  'password_length_error': 'Le mot de passe doit avoir au moins 6 caractères',
  ...
  'time_limit_desc':
      'Trouvez toutes les paires avant la fin du temps. Les paires trouvées plus rapidement rapportent plus de points.',
  ...
  'brain_health_index_desc':
      'Suivez l\'amélioration de votre indice de santé cérébrale à travers les jeux de mémoire. Des niveaux plus élevés aident à prévenir la démence.',
  'activity_graph_title': 'Graphique d\'activité',
  'activity_graph_desc':
      'Observez l\'évolution de votre indice de santé cérébrale dans le temps sur le graphique.',
  ...
  'points_to_next_level': 'Il vous faut {points} points pour le niveau suivant',
  ...
  'no_ranking_data': 'Pas de données de classement',
  ...
  'no_records_yet': 'Pas encore de records',
  'grid': 'Grille',
  ...
  'dementia_prevention_desc':
      'Les exercices cérébraux réguliers aident à réduire le risque de démence et de déclin cognitif.',
  ...
  'audio_assistance_desc':
      'Cliquez sur l\'icône audio pour entendre le mot correct. L\'audio est joué dans la langue sélectionnée.',
  ...
  'results_and_progress_desc':
      'Après la soumission, vous verrez vos résultats et pourrez commencer un nouveau test si vous le souhaitez.',
