...
const Map<String, String> frCGTranslations = {
  ...
  'multi_game_pin': 'PIN de jeu multijoueur',
  ...
  'players_score_multiplier': '({players} joueurs : score ×{multiplier})',
  ...
  'card_selection_desc':
      'Appuyez sur les cartes pour trouver les paires correspondantes.',
  ...
  'points_to_next_level':
      'Il vous faut {points} points pour passer au niveau suivant',
  ...
  'response_time_desc':
      'Les paires rapides améliorent le temps de réaction et la vitesse de traitement.',
