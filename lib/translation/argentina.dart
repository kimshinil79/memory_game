...
const Map<String, String> esARTranslations = {
  ...
  'select_up_to_3_players': 'Selecciona hasta 3 jugadores adicionales',
  'you_will_be_included': 'Siempre serás un jugador',
  'confirm': 'Confirmar',
  'retry': 'Reintentar',
  ...
  'create_pin_for_multiplayer':
      'Crea un PIN de 2 dígitos para el modo multijugador',
  'enter_2_digit_pin': 'Ingresa 2 dígitos',
  'pin_is_2_digits': 'El PIN debe tener 2 dígitos',
  'wrong_pin': 'PIN incorrecto',

  // Grid Selection Dialog texts
  'select_grid_size': 'Seleccionar tamaño de la cuadrícula',
  'choose_difficulty': 'Elegir nivel de dificultad',
  'multiplier': '×',
  ...
  'two_digit_pin_helper': 'Este PIN se usa en sesiones multijugador',
  ...
  'random_shake': '¡Sacudir las cartas!!',

  // Completion Dialog texts
  'congratulations': '¡Felicitaciones!',
  'winner': '¡Ganador: {name}!',
  'its_a_tie': '¡Empate!',
  'points_divided': '¡Los puntos se dividen entre los jugadores empatados!',
  ...
  'points_divided_explanation':
      '(Los puntos se dividen entre los jugadores empatados)',
  ...
  'card_selection_desc': 'Toca las cartas para voltearlas y encontrar pares.',
  'time_limit_title': 'Límite de tiempo',
  'time_limit_desc':
      'Encuentra todos los pares a tiempo. Los pares más rápidos ganan más puntos.',
  ...
  'brain_health_index_desc':
      'Sigue la mejora de tu índice de salud cerebral a través de juegos de memoria. Los niveles más altos aumentan la prevención de demencia.',
  'activity_graph_title': 'Gráfico de actividad',
  'activity_graph_desc':
      'Observa cómo cambia tu índice de salud cerebral con el tiempo a través del gráfico.',
  'ranking_system_title': 'Sistema de clasificación',
  'ranking_system_desc':
      'Compara tu índice de salud cerebral con otros usuarios y verifica tu clasificación.',
  'game_statistics_title': 'Estadísticas del juego',
  'game_statistics_desc':
      'Revisa diversas estadísticas como juegos jugados, pares encontrados y mejores tiempos.',
  'got_it': '¡Entendido!',
  ...
  'login_prompt_desc':
      'Inicia sesión para registrar tu índice de salud cerebral y seguir tu progreso. Mejora tus capacidades cognitivas a través de juegos de memoria.',
  ...
  'cognitive_function_desc':
      'La actividad cerebral regular ayuda a mantener y mejorar las funciones cognitivas.',
  'response_time_reduction': 'Reducción del tiempo de respuesta',
  'response_time_desc':
      'Los pares rápidos mejoran el tiempo de respuesta y la velocidad de procesamiento.',
  'dementia_prevention': 'Prevención de demencia',
  'dementia_prevention_desc':
      'El ejercicio regular del cerebro ayuda a reducir el riesgo de demencia y deterioro cognitivo.',
  ...
  'visual_memory_test_desc':
      'Prueba tu memoria con 10 preguntas. Selecciona la imagen que coincida con la palabra correcta.',
  'audio_assistance': 'Asistencia de audio',
  'audio_assistance_desc':
      'Toca el ícono de audio para escuchar la palabra correcta. El audio se reproduce en el idioma seleccionado.',
  'question_navigation': 'Navegación de preguntas',
  'question_navigation_desc':
      'Usa los indicadores numéricos en la parte superior para navegar entre preguntas o usa los botones de flecha.',
  'select_and_submit': 'Seleccionar y enviar',
  'select_and_submit_desc':
      'Selecciona una imagen para cada pregunta. Después de responder todas las preguntas, aparecerá el botón de enviar.',
  'results_and_progress': 'Resultados y progreso',
  'results_and_progress_desc':
      'Después de enviar, ve tus resultados y comienza una nueva prueba si lo deseas.',
