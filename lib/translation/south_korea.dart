...
const Map<String, String> krTranslations = {
  ...
  'dementia_prevention_desc': '정기적인 두뇌 운동은 치매와 인지 기능 저하의 위험을 줄이는 데 도움이 됩니다.',

  // Test Page 텍스트
  'memory_test': '기억력 테스트',
  'question': '문제',
  'visual_memory_test': '시각 기억력 테스트',
  'visual_memory_test_desc': '10개의 문제로 기억력을 테스트하세요. 올바른 단어와 일치하는 이미지를 선택하세요.',
  'audio_assistance': '음성 지원',
  'audio_assistance_desc': '소리 아이콘을 탭하여 올바른 단어를 들을 수 있습니다. 선택한 언어로 음성이 재생됩니다.',
  'question_navigation': '문제 탐색',
  'question_navigation_desc': '상단의 숫자 표시를 사용하여 문제 사이를 이동하거나 화살표 버튼을 사용하세요.',
  'select_and_submit': '선택 및 제출',
  'select_and_submit_desc': '각 문제에 대해 이미지를 선택하세요. 모든 문제가 답변되면 제출 버튼이 나타납니다.',
  'results_and_progress': '결과 및 진행 상황',
  'results_and_progress_desc': '제출 후 점수를 확인하고 원하는 경우 새로운 테스트를 다시 시작할 수 있습니다.',
  'how_to_play': '게임 방법',
