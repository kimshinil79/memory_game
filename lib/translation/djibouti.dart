...
const Map<String, String> arDJTranslations = {
  ...
  'card_selection_desc': 'انقر على البطاقات للعثور على الأزواج.',
  'time_limit_title': 'الحد الزمني',
  'time_limit_desc':
      'اعثر على جميع الأزواج قبل انتهاء الوقت. الأزواج الأسرع تعطي نقاطاً أكثر.',
  ...
  'short_term_memory_desc':
      'تحسن ألعاب الذاكرة بشكل فعال الذاكرة قصيرة المدى وقدرة الحفظ.',
  ...
  'response_time_desc':
      'العثور على الأزواج بسرعة يحسن وقت الاستجابة وسرعة المعالجة.',
  'dementia_prevention': 'الوقاية من الخرف',
  'dementia_prevention_desc':
      'تساعد التمارين الدماغية المنتظمة في تقليل خطر الإصابة بالخرف والتدهور المعرفي.',
  ...
  'visual_memory_test_desc':
      'اختبر ذاكرتك مع 10 أسئلة. اختر الصورة التي تتوافق مع الكلمة الصحيحة.',
  ...
  'question_navigation_desc':
      'استخدم المؤشرات الرقمية في الأعلى أو أزرار الأسهم للتنقل بين الأسئلة.',
  'select_and_submit': 'اختيار وإرسال',
  'select_and_submit_desc':
      'اختر صورة لكل سؤال. سيظهر زر الإرسال بعد الإجابة على جميع الأسئلة.',
  'results_and_progress': 'النتائج والتقدم',
  'results_and_progress_desc':
      'بعد الإرسال، سترى نتائجك ويمكنك بدء اختبار جديد إذا أردت.',
  ...
  'rainbow_brain_desc': 'دماغك يتألق ببراعة ملونة!',
  'rainbow_brain_fun':
      'لقد وصلت إلى ما يعادل قوس قزح مزدوج في الإدراك - رائع تماماً!',
  ...
  'silver_brain_desc': 'صحة دماغ جيدة مع مجال للتحسين.',
  'silver_brain_fun': 'دماغك يحمى - مثل جهاز كمبيوتر يعمل في الصباح.',
  'bronze_brain_level2': 'دماغ برونزي (المستوى 2)',
  'bronze_brain_desc': 'وظائف معرفية متوسطة - تحتاج المزيد من الألعاب!',
  'bronze_brain_fun': 'دماغك نعسان قليلاً - حان وقت بعض القهوة الذهنية!',
