...
// French translations for Djibouti
const Map<String, String> frDJTranslations = {
  ...
  'multi_game_pin': 'PIN du jeu multijoueur',
  ...
  'points_divided_explanation': '(Points partagés en cas d\'égalité)',
  ...
  'time_limit_desc':
      'Trouvez toutes les paires avant la fin du temps. Trouvez les paires rapidement pour plus de points.',
  ...
  'brain_health_index_desc':
      'Suivez l\'amélioration de votre indice de santé cérébrale à travers le jeu de mémoire. Des niveaux élevés aident à prévenir la démence.',
  ...
  'ranking_system_desc':
      'Comparez votre indice de santé cérébrale avec d\'autres utilisateurs et voyez votre classement.',
  ...
  'login_prompt_desc':
      'Connectez-vous pour suivre votre indice de santé cérébrale et voir vos progrès. Améliorez vos capacités cognitives à travers le jeu de mémoire.',
  ...
  'user': 'Utilisateur',
  'score': 'Score',
  'failed_to_load_rankings': 'Erreur lors du chargement du classement',
  ...
  'no_records_yet': 'Aucun record pour le moment',
  'grid': 'Grille',
  ...
  'cognitive_function_desc':
      'Une activité cérébrale régulière aide à protéger et améliorer les fonctions cognitives.',
  'response_time_reduction': 'Réduction du temps de réaction',
  'response_time_desc':
      'Trouver rapidement les paires améliore le temps de réaction et la vitesse de traitement.',
  ...
  'audio_assistance_desc':
      'Appuyez sur l\'icône audio pour entendre le mot correct. Le son est joué dans la langue sélectionnée.',
  ...
  'select_and_submit_desc':
      'Sélectionnez une image pour chaque question. Le bouton de soumission apparaît après avoir répondu à toutes les questions.',
  'results_and_progress': 'Résultats et progrès',
  'results_and_progress_desc':
      'Après soumission, vous verrez les résultats et pourrez commencer un nouveau test si vous le souhaitez.',
