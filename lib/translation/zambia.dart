...
// Zambia translations (English)
const Map<String, String> enZMTranslations = {
  ...
  'you_will_be_included': 'You will be included',
  'confirm': 'Confirm',
  'retry': 'Retry',
  ...
  'add_time_desc': 'Find pairs to add more time',
  'multiplayer_title': 'Multiplayer',
  'multiplayer_desc': 'Play with friends and get bonus points',
  ...
  'play_memory_games_description':
      'Play memory games to boost your brain health',
  ...
  'login_prompt_desc': 'Sign in to track your brain health',
  'sign_in': 'Sign In',
  'login': 'Login',
  ...
  'dementia_prevention_desc': 'Memory games help prevent dementia',
  ...
  'audio_assistance_desc': 'Use audio for better understanding',
  'question_navigation': 'Question Navigation',
  'question_navigation_desc': 'Navigate between questions easily',
...
'by_country': 'By Country',
  ...
  'login_prompt_1': '🎯 Sunga mafuna yako futhi uphumelele kumarekhodi omhlaba wonke!',
  'login_prompt_2': '🧠 Landelela amaphuzu akho ezempilo yobuchopho futhi ubuke intuthuko yakho!',
  'login_prompt_3': '🏆 Phonsela abangane bakho ngemidlalo yabantu abaningi!',
  'login_prompt_4': '📊 Hlola izibalo zemidlalo yakho futhi uthuthukise amakhono akho!',
  'login_prompt_5': '⭐ Bhalisela ukuvula izici eziningi ezimangalisayo!',
  'login_prompt_6': '🎮 Thuthukisa impilo yobuchopho kanye nabangane bakho!',
  'login_prompt_7': '📈 Misa amarekhodi akho futhi ukhulise amakhono akho!',
