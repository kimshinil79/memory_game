...
// Honduras translations (Spanish)
const Map<String, String> hnTranslations = {
  ...
  'enter_pin_for': 'Ingresar PIN para {name}',
  ...
  'password_length_error': 'La contraseña debe ser de 2 dígitos',
  ...
  'add_time_desc': 'Encuentra pares coincidentes para agregar más tiempo.',
  'multiplayer_title': 'Multijugador',
  'multiplayer_desc': 'Juega con amigos y compite por la puntuación más alta.',
  ...
  'brain_health_index_desc':
      'Sigue tu rendimiento cognitivo a lo largo del tiempo.',
  'activity_graph_title': 'Gráfico de actividad',
  'activity_graph_desc':
      'Consulta tu actividad diaria de entrenamiento cerebral.',
  ...
  'game_statistics_desc': 'Consulta estadísticas detalladas de tu juego.',
  'got_it': '¡Entendido!',
  ...
  'login_prompt_desc':
      'Inicia sesión para seguir tu progreso en salud cerebral.',
  ...
  'short_term_memory_desc':
      'Mejora tu capacidad para recordar información por períodos cortos.',
  ...
  'response_time_desc':
      'Entrena tu cerebro para reaccionar más rápido a estímulos visuales.',
  ...
  'audio_assistance_desc': 'Activa pistas de audio para mejor accesibilidad.',
  'question_navigation': 'Navegación de preguntas',
  'question_navigation_desc':
      'Navega fácilmente por las preguntas de la prueba.',
  ...
  'results_and_progress_desc':
      'Consulta tus resultados de prueba y sigue tu progreso.',
