...
// Mali translations (French)
const Map<String, String> frMLTranslations = {
  ...
  'no_pin_for': 'Aucun code PIN pour {name}',
  ...
  'card_selection_desc': 'Trouvez les paires de cartes correspondantes.',
  'time_limit_title': 'Limite de temps',
  'time_limit_desc': 'Terminez le jeu dans le temps imparti.',
  'add_time_title': 'Ajouter du temps',
  'add_time_desc': 'Trouvez des paires pour ajouter du temps.',
  'multiplayer_title': 'Jeu multijoueur',
  'multiplayer_desc': 'Jouez avec d\'autres, mais partagez les points.',
  ...
  'brain_health_index_desc': 'Découvrez votre niveau de santé cérébrale.',
  'activity_graph_title': 'Graphique d\'activité',
  'activity_graph_desc': 'Suivez votre activité cérébrale.',
  'ranking_system_title': 'Système de classement',
  'ranking_system_desc': 'Comparez-vous avec d\'autres joueurs.',
  'game_statistics_title': 'Statistiques du jeu',
  'game_statistics_desc': 'Consultez vos statistiques de jeu.',
  'got_it': 'Compris!',
  ...
  'welcome_to_brain_health': 'Bienvenue dans le suivi de la santé cérébrale',
  ...
  'cognitive_function_desc': 'Renforcez vos fonctions cognitives.',
  ...
  'dementia_prevention_desc':
      'Les jeux cérébraux aident à prévenir la démence.',

  // Test Page texts
  'memory_test': 'Test de mémoire',
  'question': 'Question',
  'visual_memory_test': 'Test de mémoire visuelle',
  'visual_memory_test_desc': 'Testez votre mémoire visuelle.',
  'audio_assistance': 'Assistance audio',
  'audio_assistance_desc': 'Activez l\'assistance audio.',
  'question_navigation': 'Navigation des questions',
  'question_navigation_desc':
      'Utilisez les boutons pour naviguer entre les questions.',
  ...
  'results_and_progress_desc': 'Consultez vos résultats et votre progression.',
