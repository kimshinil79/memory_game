...
// Micronesia translations (English)
const Map<String, String> fmFSMTranslations = {
  ...
  'card_selection_desc': 'Click on cards to flip them and find pairs',
  'time_limit_title': 'Time Limit',
  'time_limit_desc': 'You have limited time to complete the game',
  'add_time_title': 'Add Time',
  'add_time_desc': 'You can add more time by finding a pair',
  ...
  'inactivity_warning': "You haven't played in {days} days",
  ...
  'short_term_memory_desc':
      'Memory games improve your ability to remember information in the short term',
