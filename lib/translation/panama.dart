...
// Panama translations (Spanish)
const Map<String, String> esPATranslations = {
  ...
  'points_divided_explanation': '(puntos divididos entre los jugadores)',
  ...
  'card_selection_desc': 'Voltea las cartas para encontrar parejas.',
  ...
  'add_time_desc': 'Encuentra parejas para obtener tiempo extra.',
  ...
  'brain_health_index_desc': 'Sigue el progreso de tu salud cerebral.',
  ...
  'short_term_memory_desc': 'Aumenta la capacidad de tu memoria a corto plazo.',
  'cognitive_function_enhancement': 'Mejora de funciones cognitivas',
  'cognitive_function_desc':
      'Mejora las funciones cerebrales generales y la velocidad de procesamiento.',
  ...
  'audio_assistance_desc':
      'Activa señales de audio para mejorar la accesibilidad.',
  ...
  'select_and_submit_desc': 'Selecciona tu respuesta y envía la prueba.',
  'results_and_progress': 'Resultados y progreso',
  'results_and_progress_desc': 'Visualiza tus resultados de prueba y progreso.',
