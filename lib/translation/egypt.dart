...
// Arabic translations for Egypt
const Map<String, String> arEGTranslations = {
  ...
  'you_will_be_included': 'ستتم إضافتك دائماً كلاعب',
  'confirm': 'تأكيد',
  ...
  'enter_two_digit_pin': 'أدخل رمز PIN مكوناً من رقمين',
  ...
  'time_limit_desc':
      'اعثر على جميع الأزواج قبل انتهاء الوقت. اعثر على الأزواج بسرعة للحصول على المزيد من النقاط.',
  ...
  'brain_health_index_desc':
      'تابع تحسن مؤشر صحة دماغك من خلال لعبة الذاكرة. المستويات العالية تساعد في الوقاية من الخرف.',
  'activity_graph_title': 'رسم بياني للنشاط',
  'activity_graph_desc':
      'شاهد كيف يتغير مؤشر صحة دماغك مع مرور الوقت في الرسم البياني.',
  'ranking_system_title': 'نظام التصنيف',
  'ranking_system_desc':
      'قارن مؤشر صحة دماغك مع المستخدمين الآخرين وشاهد تصنيفك.',
  ...
  'login_prompt_desc':
      'سجل دخولك لتتبع مؤشر صحة دماغك ورؤية تقدمك. حسّن مهاراتك المعرفية من خلال لعبة الذاكرة.',
  ...
  'short_term_memory_desc':
      'تحسن ألعاب الذاكرة بشكل فعال الذاكرة قصيرة المدى وقدرة التذكر.',
  ...
  'response_time_desc':
      'يساعد العثور على الأزواج بسرعة في تحسين وقت الاستجابة وسرعة المعالجة.',
  'dementia_prevention': 'الوقاية من الخرف',
  'dementia_prevention_desc':
      'يساعد التدريب الدماغي المنتظم في تقليل خطر الإصابة بالخرف والتدهور المعرفي.',
  ...
  'question_navigation_desc':
      'استخدم المؤشرات الرقمية في الأعلى أو الأسهم للتنقل بين الأسئلة.',
  ...
  'results_and_progress_desc':
      'بعد الإرسال، سترى النتائج ويمكنك بدء اختبار جديد إذا أردت.',
