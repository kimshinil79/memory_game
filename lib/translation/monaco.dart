...
// Monaco translations (French)
const Map<String, String> mcMCTTranslations = {
  ...
  'failed_to_load_users': 'Impossible de charger les utilisateurs',
  'country': 'Pays',
  'level': 'Niveau',
  'unknown': 'Inconnu',
  ...
  'pin_is_2_digits': 'Le PIN doit avoir 2 chiffres',
  ...
  'two_digit_pin_helper': 'Le PIN doit avoir 2 chiffres',
  ...
  'must_be_two_digit': 'Doit avoir 2 chiffres',
  'current_password_required': 'Mot de passe actuel requis',
  'password_length_error': 'Le mot de passe doit avoir 2 chiffres',
  ...
  'card_selection_desc':
      'Appuyez sur les cartes pour les retourner et trouver les paires',
  'time_limit_title': 'Limite de temps',
  'time_limit_desc': 'Vous avez un temps limité pour terminer le jeu',
  'add_time_title': 'Ajouter du temps',
  'add_time_desc': 'Vous pouvez ajouter plus de temps en trouvant une paire',
  'multiplayer_title': 'Multijoueur',
  'multiplayer_desc': 'Vous pouvez jouer avec des amis sur le même appareil',
  ...
  'brain_health_index_desc':
      'Suivez vos progrès dans l\'amélioration de votre santé cérébrale',
  'activity_graph_title': 'Graphique d\'activité',
  'activity_graph_desc': 'Visualisez votre activité dans le temps',
  'ranking_system_title': 'Système de classement',
  'ranking_system_desc': 'Comparez vos performances avec les autres',
  'game_statistics_title': 'Statistiques du jeu',
  'game_statistics_desc': 'Visualisez vos statistiques détaillées',
  'got_it': 'Compris',
  ...
  'game_performance': 'Performance au jeu',
  'persistence_bonus': 'Bonus de persistance',
  'inactivity_penalty': 'Pénalité d\'inactivité',
  'inactivity_warning': 'Vous n\'avez pas joué depuis {days} jours',
  ...
  'user': 'Utilisateur',
  'score': 'Score',
  'failed_to_load_rankings': 'Impossible de charger les classements',
  ...
  'welcome_to_brain_health':
      'Bienvenue dans le tableau de bord de la santé cérébrale',
  'start_playing_memory_games':
      'Commencez à jouer à des jeux de mémoire pour améliorer votre santé cérébrale',
  'date_range': 'Période',
  ...
  'benefits_of_brain_games': 'Bénéfices des jeux cérébraux',
  'short_term_memory_improvement': 'Amélioration de la mémoire à court terme',
  'short_term_memory_desc':
      'Les jeux de mémoire améliorent votre capacité à vous souvenir d\'informations à court terme',
  'cognitive_function_enhancement': 'Amélioration des fonctions cognitives',
  'cognitive_function_desc':
      'Aide à améliorer la pensée et les capacités de résolution de problèmes',
  'response_time_reduction': 'Réduction du temps de réponse',
  'response_time_desc':
      'Améliore la vitesse de traitement de l\'information et la prise de décision',
  'dementia_prevention': 'Prévention de la démence',
  'dementia_prevention_desc':
      'Aide à maintenir la santé cérébrale et à réduire le risque de démence',
  ...
  'visual_memory_test_desc':
      'Testez votre capacité à vous souvenir des images et des motifs',
  'audio_assistance': 'Assistance audio',
  'audio_assistance_desc': 'Écoutez les instructions audio',
  'question_navigation': 'Navigation des questions',
  'question_navigation_desc':
      'Utilisez les boutons de navigation pour vous déplacer entre les questions',
  'select_and_submit': 'Sélectionner et soumettre',
  'select_and_submit_desc': 'Choisissez votre réponse et appuyez sur soumettre',
  'results_and_progress': 'Résultats et progrès',
  'results_and_progress_desc':
      'Visualisez vos résultats de test et votre progrès',
...
'by_country': 'Par Pays',
  ...
  'login_prompt_1': '🎯 Sauvegardez vos scores et compétitionnez dans les classements mondiaux!',
