...
const Map<String, String> ptBRTranslations = {
  ...
  'multi_game_pin': 'PIN para múltiplos jogadores',
  'enter_two_digit_pin': 'Digite o PIN de 2 dígitos',
  'two_digit_pin_helper':
      'Este PIN é usado para sessões com múltiplos jogadores',
  ...
  'its_a_tie': 'Empate!',
  'points_divided': 'Os pontos são divididos em caso de empate!',
  'time_seconds': 'Tempo: {seconds} segundos',
  'flips': 'Viradas: {count}',
  'players_score_multiplier': '({players} jogadores: pontos ×{multiplier})',
  'points_divided_explanation': '(Os pontos são divididos em caso de empate)',
  ...
  'card_selection_desc': 'Clique nas cartas para encontrar os pares.',
  'time_limit_title': 'Limite de tempo',
  'time_limit_desc':
      'Encontre todos os pares antes que o tempo acabe. Pares rápidos dão mais pontos.',
  'add_time_title': 'Adicionar tempo',
  'add_time_desc':
      'Clique em "+30s" para adicionar tempo (custa pontos de saúde cerebral).',
  'multiplayer_title': 'Múltiplos jogadores',
  'multiplayer_desc':
  ...
  'brain_health_index_desc':
      'Acompanhe a melhoria do seu índice de saúde cerebral através dos jogos de memória. Níveis altos ajudam a prevenir demência.',
  ...
  'age': 'Idade',
  'update': 'Atualizar',
  'points_to_next_level': 'Necessário {points} pontos para o próximo nível',
  ...
  'login_prompt_desc':
      'Faça login para acompanhar seu índice de saúde cerebral e ver seu progresso. Melhore suas habilidades cognitivas através dos jogos de memória.',
  'sign_in': 'Entrar',
  ...
  'response_time_reduction': 'Redução do tempo de reação',
  'response_time_desc':
      'Emparelhamento rápido melhora o tempo de reação e a velocidade de processamento.',
  'dementia_prevention': 'Prevenção de demência',
  'dementia_prevention_desc':
      'Exercício cerebral regular ajuda a reduzir o risco de demência e declínio cognitivo.',
  ...
  'question_navigation_desc':
      'Use os indicadores numéricos no topo ou as setas para navegar entre as perguntas.',
