...
Map<String, String> enTranslations = {
  ...
  'multi_game_pin': 'Multi-Game PIN (2 digits)',
  'pin_helper_text': '2-digit PIN for multiplayer games',
  'must_be_2_digit': 'Must be a 2-digit number',
  ...
  'calculating_brain_health_index': 'Calculating your Brain Health Index...',
  'error_calculating_index': 'Error calculating Brain Health Index',
  'age': 'Age',
  'update': 'Update',
  'points_to_next_level': 'You need {points} points to reach the next level',
